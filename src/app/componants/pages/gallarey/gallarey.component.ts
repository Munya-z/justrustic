...
export class GallareyComponent {
  ...
  pictures = [
    '/assets/images/weddingSetuptablejpg.jpg',
    '/assets/images/weddingSetup.jpg',
    '/assets/images/tBoneMainCourse.jpg',
    '/assets/images/skewers.jpg',
    '/assets/images/rollsInACircle.jpg',
    '/assets/images/rolls.jpg',
    '/assets/images/chickenBreast.jpg',
    '/assets/images/chikenAndCarrots.jpg',
    '/assets/images/dessert.jpg',
    '/assets/images/foodOnPlate.jpg',
    '/assets/images/foodOnSpoon.jpg',
    '/assets/images/foodOnTable.jpg',
    '/assets/images/hamRolls.jpg',
